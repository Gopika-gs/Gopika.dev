...
class App {
    ...
    createRopes() {
        ...
        for (let i = 0; i < TOTAL + 1; i++) {
            const x = randomFromArray([randomNumBetween(0, App.width * 0.3), randomNumBetween(App.width * 0.7, App.width)])
            const y = 0;
            const gap = randomNumBetween(App.height * 0.005, App.height * 0.05);
            const segments = 10;
